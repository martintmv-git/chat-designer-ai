...
export const appName = "Chat Designer AI";
export const appSubtitle = "Edit your photos using written instructions by chatting with a generative AI model.";
export const appMetaDescription = "Edit your photos using written instructions by chatting with a generative AI model.";
